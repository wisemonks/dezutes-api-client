...
== Instrukcijos kaip naudotis PHP API klientu:
  ...
  $estates_xml = $dezutes -> getEstates(array('estate_type' => 'house', 'for_sale' => 1, 'sort_by' => 'sale_price', 'sort_to' => 'asc',   'per_page' => 25, 'page' => 1));
...
{http://api.dezutes.lt/Dezutes.html}[http://api.dezutes.lt]
